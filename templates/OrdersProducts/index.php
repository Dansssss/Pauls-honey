        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= h($ordersProduct->date) ?></td>
                    <td><?= $this->Number->format($ordersProduct->old_quantity) ?></td>
                    <td><?= $this->Number->format($ordersProduct->new_quantity) ?></td>
                    <td><?= $this->Number->format($ordersProduct->cost_price) ?></td>
                    <td><?= $this->Number->format($ordersProduct->selling_price) ?></td>
