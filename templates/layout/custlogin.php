...
<!-- END loader -->
<?php include '../templates/Customers/HomeNavBar.php' ;?>
...
<!--                <a href="https://www.youtube.com/watch?v=WbMV9qYIXqM" class="play popup-vimeo"><i class="ion-ios-play"></i></a>-->
                ...
                <p><a href=<?=$this->Url->build(['controller'=> 'Products','action' => 'index2']) ?> role="button" class="btn smoothscroll pb_outline-light rounded-0 btn-xl pb_font-13 pb_letter-spacing-2 p-3">SHOP NOW</a></p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="col">
                ...
                <div class="tab-content">
                                    ...
                                    <li>
                                        <div class="row">
                                            <div class="col-lg-10">
                                                ...
                                                <p>
                                                    <a href=<?=$this->Url->build(['controller'=> 'Products','action' => 'view/3']) ?>><img src="../images/restaurant/800x975/img_5.jpg" alt="Instant Image" class="img-fluid"></a>
                                                </p>
                                            </div>
                                            <h3 class="pb_font-18 font-weight-bold"><span class="price"><sup>$</sup>69.95</span></h3>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        <div class="row">
                                            <div class="col-lg-10">
                                                ...
                                                <p>
                                                    <a href=<?=$this->Url->build(['controller'=> 'Products','action' => 'view/4']) ?>><img src="../images/restaurant/800x975/img_6.jpg" alt="Instant Image" class="img-fluid"></a>
                                                </p>
                                                </p>
                                            </div>
                                            <h3 class="pb_font-18 font-weight-bold"><span class="price"><sup>$</sup>20.00</span></h3>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-md">
                                <ul class="list-unstyled pb_food-menu">
                                    <li>
                                        <div class="row">
                                            <div class="col-lg-10">
                                                <h3 class="pb_font-18 font-weight-bold">Floral Blend</h3>
                                                <p>
                                                    <a href=<?=$this->Url->build(['controller'=> 'Products','action' => 'view/9']) ?>><img src="../images/products/Floral-Blend.jpg" alt="Instant Image" class="img-fluid"></a>
                                                </p>
                                                </p>
                                            </div>
                                            <h3 class="pb_font-18 font-weight-bold"><span class="price"><sup>$</sup>14.95</span></h3>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <p><a href=<?=$this->Url->build(['controller'=> 'Products','action' => 'index2']) ?> class="smoothscroll text-danger text-uppercase">View All <i class="ion-arrow-right-c"></i></a></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row align-items-center justify-content-center">
            <div class="col-md-9  order-md-1">
                ...
                <p class="sub-heading"> "If you have no Honey in your pot, have some in your mouth !  " Benjamin Franklin </p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="card border-0 mb-4">
                        <a >
                            <img class="img-fluid" src="../images/restaurant/800x975/Capture.jpg" alt="Image caption here">
