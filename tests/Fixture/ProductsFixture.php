...
class ProductsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'description' => ['type' => 'string', 'length' => 5000, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null],
        ...
        '_constraints' => [
            ...
            'products_ibfk_1' => ['type' => 'foreign', 'columns' => ['supplier_id'], 'references' => ['products', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
